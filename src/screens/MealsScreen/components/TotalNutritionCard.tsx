...
const TotalNutrition = ({ meals }: { meals: IMeal[] }) => {
  ...
  return (
    <View style={[styles.totalCard, { backgroundColor: colors.surface, shadowColor: colors.shadow }]}>
      <View style={styles.totalHeaderRow}>
        ...
        />
        <Text style={[styles.totalTitle, { color: colors["color-info-500"] }]}>{t("dailyTotal")}</Text>
      </View>

      <View style={styles.totalMacrosContainer}>
        <View style={styles.totalMacroItem}>
          <Text style={[styles.totalMacroValue, { color: colors["color-info-500"] }]}>{totals.calories}</Text>
          <Text style={[styles.totalMacroLabel, { color: colors.textSecondary }]}>{t("calories")}</Text>
        </View>
        <View style={styles.totalMacroItem}>
          <Text style={[styles.totalMacroValue, { color: colors["color-info-500"] }]}>{totals.proteins}g</Text>
          <Text style={[styles.totalMacroLabel, { color: colors.textSecondary }]}>{t("proteins")}</Text>
        </View>
        <View style={styles.totalMacroItem}>
          <Text style={[styles.totalMacroValue, { color: colors["color-info-500"] }]}>{totals.carbs}g</Text>
          <Text style={[styles.totalMacroLabel, { color: colors.textSecondary }]}>{t("carbs")} </Text>
        </View>
        <View style={styles.totalMacroItem}>
          <Text style={[styles.totalMacroValue, { color: colors["color-info-500"] }]}>{totals.fats}g</Text>
          <Text style={[styles.totalMacroLabel, { color: colors.textSecondary }]}>{t("fats")} </Text>
        </View>
      </View>
